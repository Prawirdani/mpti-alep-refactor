  ...
  return (
    <section>
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8">
        <Card className="p-4 rounded-sm min-h-44 flex place-items-center justify-center">Bookings</Card>
        <Card className="p-4 rounded-sm min-h-44 flex place-items-center justify-center">Total Day Sales</Card>
        <Card className="p-4 rounded-sm min-h-44 flex place-items-center justify-center"></Card>
